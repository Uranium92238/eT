...
- Autogenerated directories and interfaces are now ignored by git. 
  They are generated by the `setup` or the `autogenerate_files` script. See merge request eT-program/eT:!706
