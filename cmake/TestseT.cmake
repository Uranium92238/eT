...
add_eT_runtest(hf_screening_collective_coulomb_exchange     "eT;short;hf;screening")
add_eT_runtest(hf_screening_separated_coulomb_exchange      "eT;short;hf;screening")
...
#
add_eT_runtest(plot_hf_density                              "eT;short;hf;visualization")
add_eT_runtest(plot_active_hf_density_full_hf               "eT;short;hf;visualization")
...
add_eT_runtest(plot_active_hf_density_cc2                   "eT;short;cc2;visualization,gs;frozen hf")
...
add_eT_runtest(mlhf_screening_collective_coulomb_exchange   "eT;short;mlhf;screening")
add_eT_runtest(mlhf_screening_separated_coulomb_exchange    "eT;short;mlhf;screening")
...
add_eT_runtest(ccs_lr_transition_moments                    "eT;short;ccs;es;lr")
add_eT_runtest(ccs_lr_polarizability                        "eT;short;ccs;gs;lr,polarizability")
...
add_eT_runtest(ccsd_lr_polarizability_nosym                 "eT;short;ccsd;gs;lr;polarizability")
add_eT_runtest(ccsd_lr_polarizability                       "eT;short;ccsd;gs;lr;polarizability")
add_eT_runtest(ccsd_lr_transition_moments                   "eT;short;ccsd;es;lr")
...
add_eT_runtest(fci_energy_triplet_h2                        "eT;short;fci,rohf")
add_eT_runtest(fci_energy_one_electron                      "eT;short;fci,rohf")
add_eT_runtest(fci_mean_value_singlet                       "eT;short;fci,dipole,quadrupole")
add_eT_runtest(fci_mean_value_triplet                       "eT;short;fci,rohf,dipole,quadrupole")
add_eT_runtest(restart_fci                                  "eT;short;fci;restart")
add_eT_runtest(restart_fci_global                           "eT;short;fci;restart,rohf")
#
if(ENABLE_PCMSOLVER)
...
if (NOT ENABLE_FORCED_BATCHING)
   ...
   add_eT_runtest(ccsd_gs_energy_multimodel_nr                 "eT;short;ccsd;gs;multimodel")
