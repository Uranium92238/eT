...
if(CMAKE_Fortran_COMPILER_ID MATCHES GNU)
    ...
    set(CMAKE_Fortran_FLAGS "-DVAR_GFORTRAN -O3 -ffloat-store -fcray-pointer -finit-local-zero -fopenmp -g -fbacktrace")
...
if(CMAKE_Fortran_COMPILER_ID MATCHES Intel)
    ...
    set(CMAKE_Fortran_FLAGS         "-mkl -fpp -assume byterecl -xHost -qopenmp -O0 -g -traceback")
