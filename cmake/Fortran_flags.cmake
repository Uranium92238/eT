...
if(CMAKE_Fortran_COMPILER_ID MATCHES GNU)
    ...
    set(CMAKE_Fortran_FLAGS         "-DVAR_GFORTRAN -ffloat-store -fcray-pointer -finit-local-zero -fopenmp -fbacktrace")
#
...
if(CMAKE_Fortran_COMPILER_ID MATCHES Intel)
    ...
    set(CMAKE_Fortran_FLAGS         "-mkl -fpp -assume byterecl -DVAR_IFORT -g -traceback -qopenmp -O3 -check all -fp-stack-check")
