...
!
     host_input%solver_type     = pcmsolver_fstring_to_carray(trim(molecule%solver_type)//c_null_char)
!
     host_input%solvent         = pcmsolver_fstring_to_carray(trim(molecule%solvent)//c_null_char)
!
