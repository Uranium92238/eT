...
!
      type(file), private :: o ! File containing the O vector from previous iterations
      type(file), private :: x ! File containing the X vector from previous iterations
!
...
!
         read(solver%o%unit) (o_i(j,1), j = 1, solver%n_equations)
!
