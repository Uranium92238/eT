...
!
      ...
      procedure :: get_ao_g_wxyz => get_ao_g_wxyz_integrals ! g_αβγδ
!
   end type integrals
!
!
...
!
!
   subroutine get_ao_g_wxyz_integrals(int, g)
!!
...
!
      call get_ao_g_wxyz(g)
!
   end subroutine get_ao_g_wxyz_integrals
!
!
