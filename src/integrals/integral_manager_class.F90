...
!
         write(output%unit,*) 'old vecs present'
!
...
!
   end subroutine determine_auxilliary_cholesky_basis_integral_manager
!
!
...
!
                  if ((2*size_AB_test*n_cholesky*dp + (n_cholesky**2)*dp)*1.2d0 .gt. mem%available) then ! 20 percent buffer
!
