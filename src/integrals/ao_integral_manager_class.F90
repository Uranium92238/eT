...
!
      ...
      procedure :: get_ao_h_xy_sp => get_ao_h_xy_sp_ao_integral_tool   ! h_αβ
      procedure :: get_ao_s_xy   => get_ao_s_xy_ao_integral_tool   ! s_αβ
      procedure :: get_ao_g_wxyz => get_ao_g_wxyz_ao_integral_tool ! g_αβγδ
      procedure :: get_ao_g_wxyz_epsilon => get_ao_g_wxyz_epsilon_ao_integral_tool ! g_αβγδ
!
...
!
!
   subroutine get_ao_h_xy_sp_ao_integral_tool(int, h, s1, s2)
!!
!!    Get h_αβ integrals
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, 2018
!!
...
!
   end subroutine get_ao_h_xy_sp_ao_integral_tool
!
!
...
!
!
   subroutine get_ao_g_wxyz_ao_integral_tool(int, g, s1, s2, s3, s4)
!!
!!    Get g_αβγδ integrals
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, 2018
!!
!!    Fortran wrapper for the C++ routine that calculates and
!!    saves the g_αβγδ integral_tool in the array g.
!!
...
!
   end subroutine get_ao_g_wxyz_ao_integral_tool
!
!
   subroutine get_ao_g_wxyz_epsilon_ao_integral_tool(int, g, s1, s2, s3, s4, epsilon, thread, skip, &
                                                            n1, n2, n3, n4)
!!
!!    Get g_αβγδ integrals
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, 2018
...
!
   end subroutine get_ao_g_wxyz_epsilon_ao_integral_tool
!
!
