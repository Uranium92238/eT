...
!
      procedure :: get_vvoo_required_mem => get_vvoo_required_mem_mo_integral_tool
!
...
!
!
   function get_vvoo_required_mem_mo_integral_tool(integrals, dim_1, dim_2, dim_3, dim_4)
!!
...
!
      integer(i15) :: get_vvoo_required_mem_mo_integral_tool
!
      if (present(dim_1) .and. present(dim_2) .and. present(dim_3) .and. present(dim_4)) then
!
         get_vvoo_required_mem_mo_integral_tool = (dim_1*dim_2*dim_3*dim_4)
!
         get_vvoo_required_mem_mo_integral_tool = get_vvoo_required_mem_mo_integral_tool + &
...
!
         get_vvoo_required_mem_mo_integral_tool = (integrals%n_v**2)*(integrals%n_o**2)
!
         get_vvoo_required_mem_mo_integral_tool = get_vvoo_required_mem_mo_integral_tool + &
...
!
      get_vvoo_required_mem_mo_integral_tool = get_vvoo_required_mem_mo_integral_tool*dp
!
   end function get_vvoo_required_mem_mo_integral_tool
!
!
