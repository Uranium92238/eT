...
!
!
module t1_eri_tool_class
!!
!!    T1 ERI tool class module
...
!
!
   type, extends(mo_eri_tool) :: t1_eri_tool
!
...
!
      real(dp), dimension(:,:,:), allocatable :: L_J_oo_t1
      real(dp), dimension(:,:,:), allocatable :: L_J_vo_t1
      real(dp), dimension(:,:,:), allocatable :: L_J_ov_t1
      real(dp), dimension(:,:,:), allocatable :: L_J_vv_t1
!
!     Keep full electron repulsion matrix g_pqrs in memory? (+ allocatable arrays for keeping it)
!
      logical :: t1_eri_mem
      real(dp), dimension(:,:,:,:), allocatable :: g_pqrs_t1
!
!
   contains
!
!     Read, print settings
!
      procedure :: print_settings            => print_settings_t1_eri_tool
      procedure :: read_settings             => read_settings_t1_eri_tool
!
!     Cleanup
!
      procedure :: cleanup                   => cleanup_t1_eri_tool
!
!     Initialization
!
      procedure :: initialize                => initialize_t1_eri_tool
      procedure :: copy_from_mo              => copy_from_mo_t1_eri_tool
      procedure :: copy_from_t1              => copy_from_t1_t1_eri_tool
!
!     T1 Cholesky vectors
!
      procedure :: get_cholesky_t1           => get_cholesky_t1_t1_eri_tool
      procedure :: set_cholesky_t1           => set_cholesky_t1_t1_eri_tool
!
      procedure :: set_t1_to_mo              => set_t1_to_mo_t1_eri_tool
      procedure :: update_t1_integrals       => update_t1_integrals_t1_eri_tool
!
      procedure :: construct_t1_cholesky     => construct_t1_cholesky_t1_eri_tool
      procedure :: construct_cholesky_t1_oo  => construct_cholesky_t1_oo_t1_eri_tool
      procedure :: construct_cholesky_t1_vo  => construct_cholesky_t1_vo_t1_eri_tool
      procedure :: construct_cholesky_t1_vv  => construct_cholesky_t1_vv_t1_eri_tool
!
!     Get and construct routines for g_pqrs in T1 basis
!
      procedure :: get_eri_t1_mem            => get_eri_t1_mem_t1_eri_tool
      procedure :: get_eri_t1                => get_eri_t1_t1_eri_tool
      procedure :: get_g_pqrs_t1             => get_g_pqrs_t1_t1_eri_tool
...
!
      ...
      procedure :: get_eri_c1                => get_eri_c1_t1_eri_tool
      procedure :: construct_g_pqrs_c1       => construct_g_pqrs_c1_t1_eri_tool
!
      procedure :: construct_cholesky_c1_mem => construct_cholesky_c1_mem_t1_eri_tool
      procedure :: construct_cholesky_c1     => construct_cholesky_c1_t1_eri_tool
      procedure :: construct_cholesky_oo_c1  => construct_cholesky_oo_c1_t1_eri_tool
      procedure :: construct_cholesky_vo_c1  => construct_cholesky_vo_c1_t1_eri_tool
      procedure :: construct_cholesky_vv_c1  => construct_cholesky_vv_c1_t1_eri_tool
!
!     Various routines
!
      procedure :: set_pointer_t1            => set_pointer_t1_t1_eri_tool
      procedure :: L_pointer_setup_t1        => L_pointer_setup_t1_t1_eri_tool
!
   end type t1_eri_tool
!
!
   interface t1_eri_tool
!
      procedure :: new_t1_eri_tool
      procedure :: new_t1_eri_tool_from_mo
      procedure :: new_t1_eri_tool_from_t1
!
   end interface t1_eri_tool
!
!
contains
!
!
   function new_t1_eri_tool(n_o, n_v, n_J, need_g_abcd) result(eri)
!!
...
!
      if (need_g_abcd .and. eri%room_for_g_pqrs(dp)) then
!
        eri%t1_eri_mem = .true.
!
      else
...
!
   end function new_t1_eri_tool
!
!
   function new_t1_eri_tool_from_mo(template) result(eri)
!!
!!    New T1 integral tool from MO template
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, Aug 2018
!!
...
!
      call eri%print_settings()
!
   end function new_t1_eri_tool_from_mo
!
!
   function new_t1_eri_tool_from_t1(template) result(eri)
!!
!!    New T1 integral tool from T1 template
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, Aug 2018
!!
!!    Creates the integral tool based on template.
!!
...
!
      call eri%print_settings()
!
   end function new_t1_eri_tool_from_t1
!
!
   subroutine print_settings_t1_eri_tool(eri)
!!
!!    Print settings
...
!!
      implicit none
!
      class(t1_eri_tool) :: eri
!
      call eri%mo_eri_tool%print_settings()
!
      call output%printf('m', &
                         ...
                         fs='(t6,a)')
!
   end subroutine print_settings_t1_eri_tool
!
!
   subroutine read_settings_t1_eri_tool(eri)
!!
!!    Read settings
!!    Written by Eirik F. Kjønstad, Dec 2019
!!
...
!
   end subroutine read_settings_t1_eri_tool
!
!
   subroutine initialize_t1_eri_tool(eri)
!!
!!    Initialize
...
!
      class(t1_eri_tool) :: eri
!
      call eri%mo_eri_tool%initialize()
!
...
!
   end subroutine initialize_t1_eri_tool
!
!
   subroutine copy_from_mo_t1_eri_tool(eri, template)
!!
!!    Copy from MO
!!    Written by Rolf H. Myhre, Aug 2020
!!
!!    Copies MO Cholesky and MO ERIs into MO and T1 if in ERI
!!
      implicit none
!
      class(t1_eri_tool) :: eri
...
!
      call eri%mo_eri_tool%copy_from_mo(template)
!
      if (eri%cholesky_mem .and. template%cholesky_mem) then
!
         call dcopy(eri%n_J*eri%n_o*eri%n_o, &
                    template%L_J_oo_mo,  &
                    1, eri%L_J_oo_t1, 1)
!
         call dcopy(eri%n_J*eri%n_o*eri%n_v, &
                    template%L_J_ov_mo,  &
                    1, eri%L_J_ov_t1, 1)
!
         call dcopy(eri%n_J*eri%n_v*eri%n_o, &
                    template%L_J_vo_mo,  &
                    1, eri%L_J_vo_t1, 1)
!
         call dcopy(eri%n_J*eri%n_v*eri%n_v, &
                    template%L_J_vv_mo,  &
                    1, eri%L_J_vv_t1, 1)
!
      endif
...
!
   end subroutine copy_from_mo_t1_eri_tool
!
!
   subroutine copy_from_t1_t1_eri_tool(eri, template)
!!
!!    Copy from T1
!!    Written by Rolf H. Myhre, Aug 2020
!!
!!    Copies Cholesky vectors and ERIs if in memory
!!
      implicit none
!
      class(t1_eri_tool) :: eri
...
!
   end subroutine copy_from_t1_t1_eri_tool
!
!
   subroutine set_cholesky_t1_t1_eri_tool(eri, L_J_pq, first_p, last_p, first_q, last_q)
!!
!!    Set Cholesky T1
...
!
      real(dp), dimension(eri%n_J, first_p:last_p, first_q:last_q), intent(in) :: L_J_pq
!
...
!
   end subroutine set_cholesky_t1_t1_eri_tool
!
!
   subroutine get_cholesky_t1_t1_eri_tool(eri, L_J_pq, first_p, last_p, first_q, last_q)
!!
!!    Get Cholesky T1
!!    Written by Rolf H. Myhre, May 2020
!!
...
!
      ...
      integer, intent(in) :: first_q, last_q
!
      real(dp), dimension(eri%n_J, first_p:last_p, first_q:last_q), intent(out) :: L_J_pq
!
...
!
   end subroutine get_cholesky_t1_t1_eri_tool
!
!
   subroutine set_t1_to_mo_t1_eri_tool(eri)
!!
!!    Set T1 to MO
...
!
   end subroutine set_t1_to_mo_t1_eri_tool
!
!
   subroutine update_t1_integrals_t1_eri_tool(eri, t1)
!!
!!    Update T1 integrals
!!    Written by Eirik F. Kjønstad, Dec 2019
!!
...
!
      class(t1_eri_tool), intent(inout) :: eri
!
      real(dp), dimension(eri%n_v, eri%n_o), intent(in) :: t1
!
...
!
   end subroutine update_t1_integrals_t1_eri_tool
!
!
   subroutine construct_t1_cholesky_t1_eri_tool(eri, t1)
!!
...
!
   end subroutine construct_t1_cholesky_t1_eri_tool
!
!
   subroutine construct_cholesky_t1_oo_t1_eri_tool(eri, t1)
!!
...
!
!        L_J_ij_t1 = L_J_ij_mo
         call dcopy(eri%n_J*eri%n_o**2, eri%L_J_oo_mo, 1, eri%L_J_oo_t1, 1)
!
...
!
   end subroutine construct_cholesky_t1_oo_t1_eri_tool
!
!
   subroutine construct_cholesky_t1_vo_t1_eri_tool(eri, t1)
!!
...
!
!        L_J_ai_t1 = L_J_ai_mo
         call dcopy(eri%n_J*eri%n_v*eri%n_o, eri%L_J_vo_mo, 1, eri%L_J_vo_t1, 1)
!
...
!
!           L'_J_ji += L_J_ji_mo
            call daxpy(eri%n_J*eri%n_o*batch_o%length, one, &
...
!
   end subroutine construct_cholesky_t1_vo_t1_eri_tool
!
!
   subroutine construct_cholesky_t1_vv_t1_eri_tool(eri, t1)
!!
...
!
   end subroutine construct_cholesky_t1_vv_t1_eri_tool
!
!
...
!
      real(dp), dimension(eri%n_v, eri%n_o), intent(in) :: t1
!
      real(dp), dimension(:,:,:,:), allocatable :: g_temp
!
      call mem%alloc(g_temp, eri%n_mo, eri%n_mo, eri%n_mo, eri%n_mo)
!
      call dcopy(eri%n_mo**4, eri%g_pqrs_mo, 1, eri%g_pqrs_t1, 1)
!
      call dgemm('N', 'N',                                    &
...
!
      call dcopy(eri%n_mo**4, eri%g_pqrs_t1, 1, g_temp, 1)
!
      call dgemm('N', 'N',                           &
...
!
      call dgemm('N', 'N',                                    &
                 ...
                 g_temp, eri%n_mo**3)
!
      call dcopy(eri%n_mo**4, g_temp, 1, eri%g_pqrs_t1, 1)
!
      call dgemm('N', 'N',                           &
                 eri%n_v, eri%n_mo**3, eri%n_o,      &
                 -one,                               &
...
!
!
   pure subroutine get_eri_t1_mem_t1_eri_tool(eri, string, req_pq, req_rs, &
...
!
         call eri%get_eri_mem(string, req_pq, req_rs, &
                              dim_p, dim_q, dim_r, dim_s, qp, sr)
!
      endif
!
   end subroutine get_eri_t1_mem_t1_eri_tool
!
!
...
!
   end subroutine get_g_pqrs_t1_t1_eri_tool
!
!
...
!
      logical, optional, intent(in) :: qp, sr, rspq
!
      real(dp), dimension(:,:,:), pointer, contiguous :: L_J_pq_p, L_J_rs_p
!
...
!
      character(len=2), intent(in) :: string
!
      real(dp), intent(out), dimension(1) :: g_pqpq
!
      integer, optional, intent(in) :: first_p, last_p
      integer, optional, intent(in) :: first_q, last_q
!
...
!
      ...
      integer, intent(in) :: dim_p, dim_q
!
      real(dp), intent(out), dimension(dim_p*dim_q*(dim_p*dim_q+1)/2) :: g_pqpq
!
      logical, optional, intent(in) :: qp
!
      if (eri%t1_eri_mem) then
...
!
      call eri%L_pointer_setup_t1(L_J_pq_p, switch_pq, &
                                  first_p, last_p, first_q, last_q, pq_alloced)
!
      call eri%construct_g_packed_from_L(L_J_pq_p, g_pqpq, zero, dim_p, dim_q)
!
      if (pq_alloced) then
         call mem%dealloc(L_J_pq_p, eri%n_J, dim_p, dim_q)
      endif
...
!
   end subroutine get_eri_c1_mem_t1_eri_tool
!
!
...
!
   end subroutine construct_g_pqrs_c1_t1_eri_tool
!
!
   pure subroutine construct_cholesky_c1_mem_t1_eri_tool(eri, string, req_p, req_q, req_pq, &
                                                         dim_p, dim_q, qp)
!!
...
!
   end subroutine construct_cholesky_c1_mem_t1_eri_tool
!
!
   subroutine construct_cholesky_c1_t1_eri_tool(eri, L_J_pq_c1, c_ai, &
                                                first_p, last_p, first_q, last_q, qp)
!!
...
!
      ...
      integer, intent(in) :: first_q, last_q
!
      real(dp), dimension(eri%n_J, first_p:last_p, first_q:last_q), intent(out) :: L_J_pq_c1
!
      real(dp), dimension(eri%n_v, eri%n_o), intent(in) :: c_ai
!
...
!
   end subroutine construct_cholesky_c1_t1_eri_tool
!
!
   subroutine construct_cholesky_oo_c1_t1_eri_tool(eri, L_J_ij_c1, c_bj, &
...
!
      real(dp), dimension(eri%n_J,first_i:last_i,first_j:last_j), &
                target, intent(out) :: L_J_ij_c1
!
      real(dp), dimension(eri%n_v, eri%n_o), intent(in) :: c_bj
!
      logical, intent(in) :: qp
!
      real(dp), dimension(:,:,:), allocatable :: L_J_ib
      real(dp), dimension(:,:,:), pointer :: L_J_ij_p
!
...
!
   end subroutine construct_cholesky_oo_c1_t1_eri_tool
!
!
   subroutine construct_cholesky_vo_c1_t1_eri_tool(eri, L_J_ai_c1, c_ai, &
...
!
      real(dp), dimension(eri%n_J,first_a:last_a,first_i:last_i), &
...
!
      logical, intent(in) :: qp
!
      real(dp), dimension(:,:,:), allocatable         :: L_J_ij, L_J_ab
      real(dp), dimension(:,:,:), allocatable, target :: L_J_ia
      real(dp), dimension(:,:,:), pointer             :: L_J_ia_p
!
...
!
      if(.not. qp) then
         ...
         call zero_array(L_J_ia, eri%n_J*length_i*length_a)
         L_J_ia_p => L_J_ia
      endif
!
      if (eri%cholesky_mem) then
...
!
   end subroutine construct_cholesky_vo_c1_t1_eri_tool
!
!
   subroutine construct_cholesky_vv_c1_t1_eri_tool(eri, L_J_ab_c1, c_ai, &
...
!
      real(dp), dimension(eri%n_J,first_a:last_a,first_b:last_b), target, intent(out) :: L_J_ab_c1
!
      logical, intent(in) :: qp
!
      real(dp), dimension(:,:,:), allocatable         :: L_J_bi
      real(dp), dimension(:,:,:), allocatable, target :: L_J_ba
      real(dp), dimension(:,:,:), pointer             :: L_J_ba_p
!
...
!
   end subroutine construct_cholesky_vv_c1_t1_eri_tool
!
!
   subroutine set_pointer_t1_t1_eri_tool(eri, point, last_p, last_q, first_q)
!!
!!    set pointer T1
!!    written by Rolf H. Myhre, Jun 2020
!!
...
!!
      implicit none
!
      class(t1_eri_tool), intent(in), target :: eri
...
!
   end subroutine set_pointer_t1_t1_eri_tool
!
!
   subroutine L_pointer_setup_t1_t1_eri_tool(eri, point, switch, &
...
!
      real(dp), dimension(:,:,:), pointer, contiguous :: temp
      logical :: vec_in_mem
!
...
!
   end subroutine L_pointer_setup_t1_t1_eri_tool
!
!
   subroutine cleanup_t1_eri_tool(eri)
!!
!!    Cleanup
...
!
      ...
      eri%t1_eri_mem = .false.
!
   end subroutine cleanup_t1_eri_tool
!
!
end module t1_eri_tool_class
