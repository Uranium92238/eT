...
!
!
   subroutine jacobian_ccsd_transformation_ccsd(wf, c_a_i, c_aibj)
!!
...
!
!
   subroutine jacobian_ccsd_a1_ccsd(wf, rho_a_i, c_a_i)
!!
!!    Jacobian CCSD A1
...
!
!
   subroutine jacobian_ccsd_b1_ccsd(wf, rho_a_i, c_ai_bj)
!!
!!    Jacobian CCSD B1
!!    Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017 
!!
...
!
!
   subroutine jacobian_ccsd_c1_ccsd(wf, rho_a_i, c_ai_bj)
!!
!!    Jacobian CCSD C1
!!    Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017 
!!
...
!
!
   subroutine jacobian_ccsd_d1_ccsd(wf, rho_a_i, c_bi_cj)
!!
!!    Jacobian CCSD D1
!!    Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017 
!!
...
!
!
   subroutine jacobian_ccsd_a2_ccsd(wf, rho_ai_bj, c_a_i)
!!
!!    Jacobian CCSD A2 
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, May 2017
!!
...
!
      ...
      real(dp), dimension(:,:), allocatable :: L_bc_J ! L_bc^J, batching over b
!
...
!
!        Get ab-cholesky vectors for the batch, L_bc^J, then reorder from L_bc_J to L_cb_J
!
         call allocator(L_bc_J, (wf%n_v)*batch_length, wf%n_J)
         L_bc_J = zero
!
         call wf%get_cholesky_ab(L_bc_J, b_begin, b_end, 1, wf%n_v)
!
         ...
         do c = 1, wf%n_v
            do b = 1, batch_length
               ...
               bc = index_two(b, c, batch_length)
               do J = 1, wf%n_J
                  L_cb_J(cb, J) = L_bc_J(bc, J)
               enddo
            enddo
         enddo
         call deallocator(L_bc_J, (wf%n_v)*batch_length, wf%n_J)
!
...
!
!
   subroutine jacobian_ccsd_b2_ccsd(wf, rho_ai_bj, c_a_i)
!!
!!    Jacobian CCSD B2 
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, May 2017
!!
...
!
!
   subroutine jacobian_ccsd_c2_ccsd(wf, rho_ai_bj, c_a_i)
!!
!!    Jacobian CCSD C2 
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, May 2017
!!
...
!
!
   subroutine jacobian_ccsd_d2_ccsd(wf, rho_ai_bj, c_a_i)
!!
!!    Jacobian CCSD D2 
!!    Written by Sarai D. Folkestad and Eirik F. Kjønstad, May 2017
!!
...
!
      ...
      real(dp), dimension(:,:), allocatable :: L_bd_J ! L_bd^J
!
...
!
         call allocator(L_bd_J, (wf%n_v)*batch_length, wf%n_J) ! L_bd^J 
         L_bd_J = zero
         call wf%get_cholesky_ab(L_bd_J, b_begin, b_end, 1, wf%n_v)
!
         ...
         do d = 1, wf%n_v
            do b = 1, batch_length
               ...
               bd = index_two(b, d, batch_length)
               do J = 1, wf%n_J
                  L_db_J(db, J) = L_bd_J(bd, J)
               enddo
            enddo
         enddo
         call deallocator(L_bd_J, (wf%n_v)*batch_length, wf%n_J)
!
...
!
!
   subroutine jacobian_ccsd_e2_ccsd(wf, rho_ai_bj, c_ai_ck)
!!
!!    Jacobian CCSD E2 
!!    Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017
!!
...
!
!
      subroutine jacobian_ccsd_f2_ccsd(wf, rho_ai_bj, c_ai_bj)
!!
!!       Jacobian CCSD F2 
!!       Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017
!!
...
!
      subroutine jacobian_ccsd_g2_ccsd(wf, rho_ai_bj, c_ai_bj)
!!
!!       Jacobian CCSD G2 
!!       Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017
!!
...
!
      subroutine jacobian_ccsd_h2_ccsd(wf, rho_ai_bj, c_ai_bj)
!!
!!       Jacobian CCSD H2 
!!       Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017
!!
...
!
!
      subroutine jacobian_ccsd_i2_ccsd(wf, rho_ai_bj, c_ai_bj)
!!
!!       Jacobian CCSD I2 
!!       Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017
!!
...
!
!
      subroutine jacobian_ccsd_k2_ccsd(wf, rho_ab_ij, c_ab_ij)
!!
!!       Jacobian CCSD K2 
!!       Written by Eirik F. Kjønstad and Sarai D. Folkestad, May 2017
!!
