...
!
         call wf%read_cholesky_ab(L_ab_J, 1, wf%n_v, batch_first, batch_last, .false.)
!
...
!!       Read L_ab_J for batch of a
!!
!        call wf%read_cholesky_ab(L_ab_J, first, last, 1, wf%n_v, .true.) ! L_ab_J(ba) = L_ab^J 
!!
!!       Allocate L_i,Jb
!!
...
!!       Read L_ab_J for batch of b
!!
!        call wf%read_cholesky_ab(L_ab_J,1, wf%n_v, first, last, .false.)
!!
!!       Allocate L_Jb,i for batch of b
!!
!        call allocator(L_Jb_i, (wf%n_J)*batch_length, wf%n_o)
