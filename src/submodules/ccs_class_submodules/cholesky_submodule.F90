...
!
         call sort_123_to_132(L_ia_J, L_iJ_a, i_length, wf%n_v, wf%n_J)
!
!        Deallocate L_ia_J
!
...
!
         call add_132_to_123(one, L_iJ_k, L_ij_J, i_length, j_length, wf%n_J)
!
...
!     Reorder L_ia_J to L_iJ_a
!
      call sort_123_to_132(L_ia_J, L_iJ_a, wf%n_o, wf%n_v, wf%n_J)
!
!     Deallocate L_ia_J
!
...
!    Place terms from L_iJ_k into L_ij_J
!
      call add_132_to_123(one, L_iJ_k, L_ij_J, wf%n_o, wf%n_o, wf%n_J)
!
!     Deallocate L_iJ_k and L_iJ_a
!
...
!
         call add_312_to_123(one, L_Ja_i, L_ai_J, a_length, i_length, wf%n_J)
!
!        Deallocate L_Ja_i
!
...
!
         call sort_123_to_213(L_ik_J, L_k_iJ, i_length, wf%n_o, wf%n_J)
!
...
!
         call daxpy(i_length*a_length*(wf%n_J), one, L_a_iJ, 1, L_ai_J, 1)
!
...
!
         call sort_123_to_132(L_kb_J, L_kJ_b, wf%n_o, wf%n_v, wf%n_J)
!
!        Deallocate L_kb_J
!
...
!
         call sort_123_to_132(L_kJ_i, L_k_iJ, wf%n_o, wf%n_J, i_length)
!
!        Deallocate L_kJ_i
!
...
!        L_ai_J(ai, J) = L_ai_J(ai, J) + L_a_iJ(a, iJ)
!
         call daxpy(a_length*i_length*(wf%n_J), one, L_a_iJ, 1, L_ai_J, 1)
!
!        Deallocations
!
...
!        Add terms to T1-transformed Cholesky AI vector
!
         call add_312_to_123(one, L_Ja_i, L_ai_J, wf%n_v, wf%n_o, wf%n_J)
!
!        Deallocate L_Ja_i
!
...
!        L_k_iJ(k, iJ) = L_ik_J(ik, J)
!
         call sort_123_to_213(L_ik_J, L_k_iJ, wf%n_o, wf%n_o, wf%n_J)
!
!        Calculate -sum_k t_a_k*L_k_iJ = L_a_iJ  ! Here we assume L_ik^J = L_ki^J
!
         call dgemm('N','N',            &
...
!        L_k_iJ(k, iJ) = L_kJ_i(kJ, i)
!
         call sort_123_to_132(L_kJ_i, L_k_iJ, wf%n_o, wf%n_J, wf%n_o)
!
!        Deallocate L_kJ_i
!
