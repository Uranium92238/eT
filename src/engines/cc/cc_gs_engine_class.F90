...
!
   contains
!
      procedure, public :: ignite => ignite_cc_gs_engine
      procedure, public :: set_allowed_wfs => set_allowed_wfs_cc_gs_engine
!
   end type cc_gs_engine
!
contains
!
!
   subroutine ignite_cc_gs_engine(this, wf)
!!
!!    Ignite
...
!
      implicit none
!
      class(cc_gs_engine), intent(inout) :: this
...
!
!
   subroutine set_allowed_wfs_cc_gs_engine(this)
!!
...
!
      call this%allowed_cc_wfs%set('mp2',             allowed=.true.)
      ...
      call this%allowed_cc_wfs%set('ccsd(t)',         allowed=.true.)
...
!
   end subroutine set_allowed_wfs_cc_gs_engine
!
!
end module cc_gs_engine_class
