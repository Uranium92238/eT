...
!
!
module fci_task_class
!
!!
!! FCI task class module
!! Written by Eirik F. Kjønstad, Alexander C. Paul, May 2022
!!
!
...
!
         implicit none
!
         class(fci_task), intent(inout) :: this
!
         class(fci), intent(inout), target :: wf
!
