...
!
!!
!!    TDHF right-hand side class module
...
contains
!
   function new_tdhf_rhs_tool(wf, component) result(this)
!!
!!    New
!!    Written by Regina Matveeva, Sept 2021
!!
...
!
      call this%wf%get_dipole_gradient(rhs, this%component)
      call dscal(this%n_parameters, -one, rhs, 1)
!
