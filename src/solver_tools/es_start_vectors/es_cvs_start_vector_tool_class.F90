...
!
!
module es_cvs_start_vector_tool_class
!
!!
!!    Excited state cvs start vector tool class module
...
!
   implicit none
!
   type, extends(es_start_vector_tool) :: es_cvs_start_vector_tool
!
   contains
!
...
!
!
   interface es_cvs_start_vector_tool
!
      procedure :: new_es_cvs_start_vector_tool
!
   end interface es_cvs_start_vector_tool
!
!
contains 
!
