...
!
      ...
      procedure :: get_triples_cvs_projector_abc_batch &
                                                   => get_triples_cvs_projector_abc_batch_cc3
!
...
!
!     Routines related to EOM transition densities
!
...
!
      procedure :: right_transition_density_cc3_ov_gs_contr => right_transition_density_cc3_ov_gs_contr_cc3
      procedure :: right_transition_density_cc3_Y_contr     => right_transition_density_cc3_Y_contr_cc3
      procedure :: right_transition_density_vo_contr_to_ov  => right_transition_density_vo_contr_to_ov_cc3
      procedure :: right_transition_density_cc3_ijk         => right_transition_density_cc3_ijk_cc3
      procedure :: right_transition_density_cc3_abc         => right_transition_density_cc3_abc_cc3
      procedure :: right_transition_density_cc3_Z_contr     => right_transition_density_cc3_Z_contr_cc3
      procedure :: right_transition_density_vo_N6           => right_transition_density_vo_N6_cc3
      procedure :: construct_Z_intermediate                 => construct_Z_intermediate_cc3
!
!     Routines for constructing the R-TDM in a debug way
