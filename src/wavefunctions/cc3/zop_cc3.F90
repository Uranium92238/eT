...
!
      call wf%prepare_cc3_integrals_t3_abc
      call wf%prepare_cc3_integrals_L3_abc
!
...
!
                        call wf%omega_cc3_eps_abc(a, b, c, t_ijk(:,:,:,thread_n))
!
...
!                       ! omega = 0
                        call wf%omega_cc3_eps_abc(a, b, c, tbar_ijk(:,:,:,thread_n), omega) 
!
                        if (cvs) then
