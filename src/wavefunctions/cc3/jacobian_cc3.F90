...
!
      call wf%construct_c1_cholesky(wf%L_t1, L_c1, c(1:wf%n_t1))
...
!
!
   module subroutine jacobian_cc3_t3_b2_cc3(wf, rho_abij, cvs, rm_core, eri_c1)
!!
!!    Jacobian CC3 T3 B2
!!    Written by Alexander C. Paul and Rolf H. Myhre, April 2019
!!    Adapted to give a contravariant representation of rho2 due to the
...
!
      ...
      call wf%construct_c1_fock(F_ov_ck_c1, eri_c1)
!
...
!
!
   module subroutine construct_c1_fock_cc3(wf, F_ia_c1, eri_c1)
!!
