...
!
      call wf%jacobian_g2_intermediate_vv%read_(Y_ac, wf%n_v**2)
!
...
!
      call wf%jacobian_g2_intermediate_oo%read_(Y_il, wf%n_o**2)
!
...
!
      call wf%jacobian_g2_intermediate_vv%open_('read', 'rewind')
!
      call wf%jacobian_g2_intermediate_vv%read_(Y_bd, wf%n_v**2)
!
      call wf%jacobian_g2_intermediate_vv%close_('keep')
!
      call dgemm('N', 'N',             &
...
!
      call wf%jacobian_g2_intermediate_oo%open_('read', 'rewind')
!
      call wf%jacobian_g2_intermediate_oo%read_(Y_jl, wf%n_o**2)
!
      call wf%jacobian_g2_intermediate_oo%close_('keep')
!
      call dgemm('N', 'T',             &
...
!!       jacobian_g2_intermdiate_oo
!!       jacobian_g2_intermdiate_vv
!!
...
!
      call wf%jacobian_g2_intermediate_vv%write_(Y_bd, wf%n_v**2)
!
      call mem%dealloc(Y_bd, wf%n_v, wf%n_v)
!
      call wf%jacobian_g2_intermediate_vv%close_('keep')
...
!
      call wf%jacobian_g2_intermediate_oo%write_(Y_jl, wf%n_o**2)
!
      call mem%dealloc(Y_jl, wf%n_o, wf%n_o)
!
      call wf%jacobian_g2_intermediate_oo%close_('keep')
