...
!
      call wf%gs_one_el_density_cc2_ov(wf%left_transition_density, L_ai, t_aibj)
!
...
!$omp end parallel do
!
      call wf%gs_one_el_density_cc2_oo(wf%left_transition_density, L_aibj, t_aibj)
      call wf%gs_one_el_density_cc2_vv(wf%left_transition_density, L_aibj, t_aibj)
!
...
!
      call wf%right_transition_density_cc2_ov(tbar_aibj, R_ai)
      call wf%right_transition_density_cc2_vo(tbar_aibj, R_ai)
!
...
!
      call wf%gs_one_el_density_cc2_oo(wf%right_transition_density, tbar_aibj, R_aibj)
      call wf%gs_one_el_density_cc2_vv(wf%right_transition_density, tbar_aibj, R_aibj)
!
      call mem%dealloc(tbar_aibj, wf%n_v, wf%n_o, wf%n_v, wf%n_o)
!
      call wf%gs_one_el_density_cc2_ov(wf%right_transition_density, wf%t1bar, R_aibj)
!
