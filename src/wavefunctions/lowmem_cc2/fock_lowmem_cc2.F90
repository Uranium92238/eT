...
!
!
submodule (lowmem_cc2_class) fock_lowmem_cc2
!
!!
!!    Fock submodule
!!
...
!
!
   module subroutine construct_fock_lowmem_cc2(wf, task)
!!
!!    Construct Fock
...
!
         call output%error_msg('did not recognize task in &
                                 &construct_fock_lowmem_cc2')
!
      endif
!
