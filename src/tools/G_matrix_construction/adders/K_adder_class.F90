...
!
   implicit none
!
   type, extends(abstract_G_adder) :: K_adder
!
   contains
!
      procedure, nopass :: add => add_K_adder
!
   end type K_adder
!
!
...
!
!
   subroutine add_K_adder(ao, D, G, eri, s1, s2, s3, s4, thread, n_threads, degeneracy)
!!
!!    Add
!!    Written by Sarai D. Folkestad, 2021
!!
...
!
      ...
      enddo
!
   end subroutine add_K_adder
!
!
end module K_adder_class
