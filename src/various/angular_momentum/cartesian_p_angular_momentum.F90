...
!
!
module cartesian_p_angular_momentum_class
!
!!
!!    Cartesian p angular momentum class
...
!
      procedure :: new_cartesian_p_angular_momentum
!
   end interface cartesian_p_angular_momentum
!
!
contains
!
!
   function new_cartesian_p_angular_momentum() result(this)
!!
!!    New cartesian p angular momentum
!!    Written by Alexander C. Paul, June 2021
!!
      implicit none
!
      type(cartesian_p_angular_momentum) :: this
!
      integer :: i
!
      this%l = 1
...
!
   end function new_cartesian_p_angular_momentum
!
!
end module cartesian_p_angular_momentum_class
