...
extern vector<libint2::Engine> kinetic; // The kinetic energy engine
extern vector<libint2::Engine> nuclear; // The nuclear attraction engine
//extern libint2::Engine kinetic; 										 
//extern libint2::Engine nuclear; 										 
