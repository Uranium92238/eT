...
with parameters_file as lines:
    while True:
        ...
        #
        while (len(line_without_comments) > 0) and (line_without_comments[-1] == "&"):
            #
            try:
...
for directory_name in wavefunction_classes:
    #
    try:
        rmtree((wavefunction_directory / directory_name / autogenerated_directory_name))
    except:
        print(
    ...
    for submodule_name in wavefunction_complexified_submodules[directory_name]:
        ...
        with real_submodule_file as lines:
            while True:
                ...
                #           routines
                #
                if search(r"\b" + "module" + r"\b", line_without_comments) and search(
    ...
    for submodule_name in wavefunction_complexified_submodules[directory_name]:
        ...
        with real_submodule_file as lines:
            while True:
                    ...
                    for procedure_name in excluded_procedures:
                        ...
                        if search(
                            ...
                            while True:
                                ...
                                #
                                if (
                                    search(r"\b" + "end" + r"\b", line_without_comments)
                                    and (
                                        search(
                                            r"\b" + "subroutine" + r"\b",
                                            line_without_comments,
                ...
                #
                line = sub(r"\b" + "construct_mu" + r"\b", "construct_mu_complex", line)
                line = sub(r"\b" + "construct_h" + r"\b", "construct_h_complex", line)
                line = sub(r"\b" + "construct_q" + r"\b", "construct_q_complex", line)
                line = sub(
