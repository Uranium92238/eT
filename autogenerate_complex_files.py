...
parameters_file_directory = join(source_directory, 'various')
wavefunction_directory = join(source_directory, 'wavefunctions')
autogenerated_directory_name = 'autogenerated_complex_files'
#
...
#
parameters_file = open(join(parameters_file_directory, 'parameters.F90'),'r')
#
parameter_list = []
#
...
#
   try:
      rmtree(join(wavefunction_directory, directory_name,
...
for directory_name in wavefunction_classes:
#
   mkdir(join(wavefunction_directory, directory_name,
              autogenerated_directory_name))
#
...
#
   class_file = open(join(wavefunction_directory, directory_name, class_name),
                     'r')
#
...
#
      real_submodule_file = open(join(wavefunction_directory, directory_name,
                                      submodule_name), 'r')
#
#     Read until 'contains' or end of file
#
...
#
      real_submodule_file = open(join(wavefunction_directory, directory_name,
                                      submodule_name), 'r')
      complex_submodule_file = open(join(wavefunction_directory,
                                         directory_name,
                                         autogenerated_directory_name,
                                         submodule_name
                                         .rstrip('.F90')+'_complex.F90'), 'w')
#
      with real_submodule_file as lines:
         while True:
#
